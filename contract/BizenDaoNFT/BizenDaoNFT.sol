...
/**
 * @title BizenDao NFT
 * @notice Optimized NFT contract for BizenDao community
 */
contract BizenDaoNFT is ERC721, ERC721Enumerable, ERC2981, Ownable {
    ...
    string private _contractName = "BizenDao NFT";
    string private _contractSymbol = "BIZEN";
    ...
    constructor() ERC721("BizenDao NFT", "BIZEN") {}
