...
import "./IBizenDaoMembersSBT.sol";

/**
 * @title BizenDaoMembersSBT Interface Usage Example
 * @notice インターフェースを使用した実装例
 */
contract BizenDaoIntegration {
    IBizenDaoMembersSBT public membersSBT;
    
    constructor(address _sbtContract) {
        membersSBT = IBizenDaoMembersSBT(_sbtContract);
    }
